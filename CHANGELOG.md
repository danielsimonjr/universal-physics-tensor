...
### Added
- `evaluatePerihelionPrecession` (BE-52 Einstein 1915). Closed-form Δφ = 6πGM/(a(1−e²)c²) per orbit; reproduces Mercury's ~43 arcsec/century anomalous precession to <0.5". Domain: bound orbits only (0 ≤ e < 1, a > 0, T > 0). Bridge catalog 41 → 42 (IDs 11-52). Geodesic cross-validation deferred to sub-task 16b.
