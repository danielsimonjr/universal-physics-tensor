...
**Current version:** v0.25.0 on npm
...
[`docs/architecture/PHYSICS_MAP.md`](docs/architecture/PHYSICS_MAP.md)).
...
| Test suite | **2874** passing (4 skipped, 1 todo; incl. property-based algebra tests) across 280 files — gated by CI |
