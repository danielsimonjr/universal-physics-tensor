...
**Current version:** v0.38.0 — [npm `latest`](https://www.npmjs.com/package/universal-physics-tensor)
— building on
...
| Test suite | **3595** passing (4 skipped, 1 todo; incl. property-based algebra tests) across 333 files — gated by CI |
