...
- [ ] **Step 1: Write the failing test** — `tests/numerical/engine-conformance.float64.test.ts`
...
- [ ] **Step 3: Write `src/numerical/float64-engine.ts`** (Task 4 portion — tensor ops are stubbed with a throw, filled in Task 5)
...
- [ ] **Step 4: Write `src/numerical/errors.ts`**
