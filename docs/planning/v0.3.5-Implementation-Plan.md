...
- [ ] **Step 1: Add `NumericalInputs` to `src/numerical/types.ts`**
...
- [ ] **Step 2: Write the failing test** — `tests/numerical/lowering-contract.test.ts`
...
- [ ] **Step 3: Write `src/numerical/lowering.ts`**
