...
- [ ] **Step 1: Write the failing test** — `tests/numerical/pderiv.test.ts`
...
- [ ] **Step 3: Write `src/numerical/grid-field.ts`** (replace the placeholder)
...
- [ ] **Step 4: Write `src/numerical/pderiv.ts`**
...
- [ ] **Step 5: Wire the `tensor-partial-derivative` case in `src/numerical/lowering.ts`**
