...
- [ ] **Step 1: Update the test to demand the full tier** — `tests/numerical/engine-conformance.float64.test.ts`
...
- [ ] **Step 3: Replace the four stubbed methods in `src/numerical/float64-engine.ts`**
