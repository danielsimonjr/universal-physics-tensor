...
- [ ] **Step 1: Write the failing test** — `tests/numerical/metric-inverse.test.ts`
...
- [ ] **Step 3: Write `src/numerical/metric-inverse.ts`**
...
- [ ] **Step 4: Wire BOTH paths — the numerical check into `evaluateNumerical()`, the symbolic check as opt-in**
