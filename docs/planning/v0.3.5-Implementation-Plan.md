...
## Task 10 [x]: `pderiv.ts` + `grid-field.ts` — numerical partial derivative
...
- [ ] **Step 1: Write the failing test** — `tests/numerical/engine-conformance.mathts.test.ts`
...
- [ ] **Step 3: Write `src/numerical/mathts-engine.ts`**
