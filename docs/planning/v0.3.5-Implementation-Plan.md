...
- [x] **Step 1: Write the failing test** — `tests/bridges/be-37-numerical-eikonal.test.ts`
...
- [x] **Step 3: Add `evaluateBE37EikonalNumerical()` to `src/bridges/equations/be-37-shapiro-delay.ts`**
