...
- [ ] **Step 1: Write the failing test** — `tests/numerical/tensor-engine-types.test.ts`
...
- [ ] **Step 3: Write `src/numerical/types.ts`**
...
- [ ] **Step 4: Write `src/numerical/tensor-engine.ts`**
...
- [ ] **Step 6: Write the parameterized conformance suite** — `tests/numerical/engine-conformance.ts`
