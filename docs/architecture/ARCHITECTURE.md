...
| Metric | Value |
|--------|-------|
| Source files | 348 TypeScript files under `src/` (860 across the whole repository, including tests and tooling) |
...
| Claim | Value | Source |
|---|---|---|
| totalSourceFiles | 860 | dependency-graph.json |
| totalExports | 3070 | dependency-graph.json |
...
(`npm run docs:deps`): 348 files, 2452 exports, 1232 of them re-exports. 860 and 348 do not
