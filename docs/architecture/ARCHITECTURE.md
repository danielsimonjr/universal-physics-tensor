...
| Metric | Value |
|--------|-------|
| Source files | 351 TypeScript files under `src/` (888 across the whole repository, including tests and tooling) |
...
(`npm run docs:deps`): 351 files, 2471 exports, 1239 of them re-exports. 888 and 351 do not
