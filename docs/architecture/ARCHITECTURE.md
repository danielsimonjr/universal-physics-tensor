...
| Metric | Value |
|--------|-------|
| Source files | 350 TypeScript files under `src/` (875 across the whole repository, including tests and tooling) |
...
| Claim | Value | Source |
|---|---|---|
| totalSourceFiles | 875 | dependency-graph.json |
...
(`npm run docs:deps`): 350 files, 2466 exports, 1238 of them re-exports. 875 and 350 do not
