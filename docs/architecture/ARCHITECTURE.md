...
| Metric | Value |
|--------|-------|
| Source files | 349 TypeScript files under `src/` (866 across the whole repository, including tests and tooling) |
...
(`npm run docs:deps`): 349 files, 2453 exports, 1232 of them re-exports. 866 and 349 do not
