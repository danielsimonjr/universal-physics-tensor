...
| Metric | Value |
|--------|-------|
| Source files | 350 TypeScript files under `src/` (876 across the whole repository, including tests and tooling) |
...
| Claim | Value | Source |
|---|---|---|
| totalSourceFiles | 876 | dependency-graph.json |
...
(`npm run docs:deps`): 350 files, 2467 exports, 1238 of them re-exports. 876 and 350 do not
