...
| Metric | Value |
|--------|-------|
| Source files | 350 TypeScript files under `src/` (874 across the whole repository, including tests and tooling) |
...
| Claim | Value | Source |
|---|---|---|
| totalSourceFiles | 874 | dependency-graph.json |
...
(`npm run docs:deps`): 350 files, 2464 exports, 1238 of them re-exports. 874 and 350 do not
