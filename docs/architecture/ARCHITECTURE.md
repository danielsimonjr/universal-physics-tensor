...
| Metric | Value |
|--------|-------|
| Source files | 348 TypeScript files under `src/` (862 across the whole repository, including tests and tooling) |
...
(`npm run docs:deps`): 348 files, 2452 exports, 1232 of them re-exports. 862 and 348 do not
