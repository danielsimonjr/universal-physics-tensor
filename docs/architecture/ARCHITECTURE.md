...
| Metric | Value |
|--------|-------|
| Source files | 348 TypeScript files under `src/` (847 across the whole repository, including tests and tooling) |
...
(`npm run docs:deps`): 348 files, 2450 exports, 1232 of them re-exports. 847 and 348 do not
