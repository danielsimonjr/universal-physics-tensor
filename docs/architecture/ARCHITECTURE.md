...
| Metric | Value |
|--------|-------|
| Source files | 348 TypeScript files under `src/` (850 across the whole repository, including tests and tooling) |
...
| Claim | Value | Source |
|---|---|---|
| totalSourceFiles | 850 | dependency-graph.json |
...
(`npm run docs:deps`): 348 files, 2450 exports, 1232 of them re-exports. 850 and 348 do not
