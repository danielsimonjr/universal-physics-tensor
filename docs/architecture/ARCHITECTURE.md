...
| Metric | Value |
|--------|-------|
| Source files | 350 TypeScript files under `src/` (878 across the whole repository, including tests and tooling) |
...
(`npm run docs:deps`): 350 files, 2467 exports, 1238 of them re-exports. 878 and 350 do not
