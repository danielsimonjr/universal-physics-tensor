...
| Metric | Value |
|--------|-------|
| Source files | 351 TypeScript files under `src/` (892 across the whole repository, including tests and tooling) |
...
(`npm run docs:deps`): 351 files, 2475 exports, 1241 of them re-exports. 892 and 351 do not
