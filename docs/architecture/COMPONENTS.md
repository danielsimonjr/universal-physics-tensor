...
| Claim | Value | Source |
|---|---|---|
| totalSourceFiles | 885 | dependency-graph.json |
| totalExports | 3117 | dependency-graph.json |
| totalTypeOnlyImports | 894 | dependency-graph.json |
...
(`bun run docs:deps`): 351 files, 2470 exports, 1239 of them re-exports. 885 and 351 do not
