...
| Total Test Files | 390 |
| Source Files with Tests | 302 |
...
| `atlas/coverage.ts` | `coverage.test.ts` |
| `atlas/derive-evidence.ts` | `coverage.test.ts`, `derive-evidence.test.ts` |
| `atlas/error-algebra.ts` | `error-algebra.test.ts` |
| `oscillators/bridges-coarse.ts` | `oscillators-coarse.test.ts` |
| `oscillators/bridges-exact.ts` | `oscillators-exact.test.ts` |
| `oscillators/bridges-limits.ts` | `oscillators-limits.test.ts` |
| `oscillators/dimensions.ts` | `models.test.ts`, `oscillators-coarse.test.ts`, `regime.test.ts` |
| `oscillators/index.ts` | `atlas-json.test.ts`, `evidence-rule.test.ts`, `serialize.test.ts` |
...
| `atlas/types.ts` | `composition-table.test.ts`, `coverage.test.ts`, `error-algebra.test.ts`, `evidence-rule.test.ts`, `oscillators-limits.test.ts`, `overlay-types.test.ts`, `regime.test.ts`, `compose-relation.test.ts` |
...
| `bridges/membership.ts` | `public-surface.test.ts`, `coverage.test.ts`, `derive-evidence.test.ts`, `bridge-equations-facade.test.ts`, `membership.test.ts`, `public-api-stability.test.ts`, `graphs.test.ts`, `tensor.test.ts` |
...
| `bridges/rejected.ts` | `public-surface.test.ts`, `coverage.test.ts`, `derive-evidence.test.ts`, `bridge-equations-facade.test.ts`, `membership.test.ts`, `public-api-stability.test.ts`, `graphs.test.ts`, `catalog-full.test.ts`, `tensor.test.ts` |
...
| `commands/audit.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/axes.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/candidates.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/canonical.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/confront.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/connectors.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/coverage.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/derive.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/discover.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/eval.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/evaluate.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/explain.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/ground.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/index.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/map.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/predict.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/priority.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/probe.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/recover.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `commands/symbolic.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
| `cli/errors.ts` | `args.test.ts`, `graphs.test.ts`, `main-dispatch.test.ts` |
| `cli/graphs.ts` | `graphs.test.ts` |
| `cli/main.ts` | `cli-from-src.test.ts`, `confront.test.ts`, `explain-bridge-redirect.test.ts`, `inprocess-golden.test.ts`, `json-contract.test.ts`, `main-dispatch.test.ts`, `new-commands.test.ts`, `probe.test.ts`, `source-extension.test.ts`, `upt-discover-opts.test.ts` |
...
| `probe/backend-protocol.ts` | `graphs.test.ts`, `backend.test.ts`, `coverage-backfill.test.ts` |
| `probe/candidate-store.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `modules.test.ts` |
| `probe/corpus.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `modules.test.ts` |
| `probe/dataset.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `modules.test.ts` |
| `probe/experiment-design.ts` | `graphs.test.ts`, `experiment-design.test.ts`, `modules.test.ts` |
| `probe/falsify.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `modules.test.ts` |
| `probe/fingerprint.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `modules.test.ts` |
| `probe/fit.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `family-b.test.ts`, `modules.test.ts` |
| `probe/frontier.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `family-b.test.ts`, `modules.test.ts` |
| `probe/generator.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `family-b.test.ts`, `modules.test.ts` |
| `probe/index.ts` | `graphs.test.ts` |
| `probe/limits.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `modules.test.ts` |
| `probe/metadata.ts` | `graphs.test.ts`, `modules.test.ts` |
| `probe/pipeline.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `family-b.test.ts` |
| `probe/problem.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `family-b.test.ts`, `modules.test.ts`, `parse-expr-json.test.ts` |
| `probe/report.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `family-b.test.ts` |
| `probe/residual.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `modules.test.ts` |
| `probe/run-manifest.ts` | `graphs.test.ts`, `modules.test.ts` |
| `probe/scoring.ts` | `graphs.test.ts`, `modules.test.ts` |
| `probe/search-budget.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `modules.test.ts` |
| `probe/serialize.ts` | `graphs.test.ts`, `serialize.test.ts` |
| `probe/structure.ts` | `graphs.test.ts`, `coverage-backfill.test.ts`, `modules.test.ts` |
| `probe/types.ts` | `graphs.test.ts`, `modules.test.ts` |
...
| `dimensional/buckingham.ts` | `public-surface.test.ts`, `oscillators-coarse.test.ts`, `bridge-equations-facade.test.ts`, `public-api-stability.test.ts`, `dimensional-classics.test.ts`, `dimensional-fields.test.ts`, `graphs.test.ts`, `buckingham.test.ts`, `derivation-benchmark.test.ts`, `tensor.test.ts` |
...
| `dimensional/curvature-invariants.ts` | `public-surface.test.ts`, `bridge-equations-facade.test.ts`, `public-api-stability.test.ts`, `graphs.test.ts`, `curvature-invariants.test.ts`, `validator-registry.test.ts`, `kretschmann-lowering.test.ts`, `tensor.test.ts` |
