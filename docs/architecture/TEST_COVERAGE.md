...
| Metric | Count |
|--------|-------|
| Total Source Files | 319 |
| Total Test Files | 412 |
| Source Files with Tests | 318 |
...
| `composition/expr-simplify.ts` | `witness-runners.test.ts`, `graphs.test.ts`, `recover-conventions.test.ts`, `symbolic-simplification.test.ts` |
