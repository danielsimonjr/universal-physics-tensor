...
|-----------|---------------------|
| `api/public-surface.test.ts` | 99 files |
...
| `bridges/bridge-equations-facade.test.ts` | 103 files |
...
| `bridges/public-api-stability.test.ts` | 100 files |
