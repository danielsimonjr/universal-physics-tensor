...
| `composition/bridge-analysis.ts` | `bridge-priority.test.ts`, `link-candidates.test.ts`, `linkage-map.test.ts`, `bridge-derivation-audit.test.ts` |
...
|-----------|---------------------|
| `api/public-surface.test.ts` | 71 files |
...
| `composition/bridge-priority.test.ts` | 15 files |
| `composition/calibration-targets.test.ts` | 17 files |
| `composition/catalog-full.test.ts` | 19 files |
| `composition/catalog-tranche.test.ts` | 18 files |
| `composition/compose-properties.test.ts` | 15 files |
| `composition/compose.test.ts` | 15 files |
| `composition/enumerate-uncertainty.test.ts` | 17 files |
| `composition/explain.test.ts` | 15 files |
| `composition/identifiability.test.ts` | 15 files |
| `composition/link-candidates.test.ts` | 15 files |
| `composition/linkage-map.test.ts` | 15 files |
| `composition/namespacing.test.ts` | 16 files |
| `composition/quantities.test.ts` | 15 files |
| `composition/retrodiction.test.ts` | 15 files |
| `composition/stress-tests.test.ts` | 14 files |
