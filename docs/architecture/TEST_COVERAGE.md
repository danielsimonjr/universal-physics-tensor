...
| `composition/compose.ts` | `public-surface.test.ts`, `calibration-targets.test.ts`, `catalog-full.test.ts`, `catalog-tranche.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `enumerate-uncertainty.test.ts`, `explain.test.ts`, `identifiability.test.ts`, `namespacing.test.ts`, `quantities.test.ts`, `retrodiction.test.ts`, `stress-tests.test.ts`, `tensor.test.ts` |
...
| `dimensional/buckingham.ts` | `public-surface.test.ts`, `buckingham.test.ts`, `tensor.test.ts` |
