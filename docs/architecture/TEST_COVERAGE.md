...
|-----------|---------------------|
| `api/public-surface.test.ts` | 88 files |
...
| `bridges/bridge-equations-facade.test.ts` | 92 files |
...
| `composition/bridge-prediction.test.ts` | 23 files |
| `composition/bridge-priority.test.ts` | 21 files |
| `composition/calibration-targets.test.ts` | 23 files |
| `composition/canonical-graph.test.ts` | 7 files |
| `composition/catalog-full.test.ts` | 25 files |
| `composition/catalog-tranche.test.ts` | 24 files |
| `composition/compose-properties.test.ts` | 21 files |
| `composition/compose.test.ts` | 21 files |
| `composition/discovery-canonical-kind.test.ts` | 4 files |
| `composition/discovery-magnitude.test.ts` | 3 files |
| `composition/discovery.test.ts` | 23 files |
| `composition/enumerate-uncertainty.test.ts` | 23 files |
| `composition/explain.test.ts` | 21 files |
| `composition/graph-viz-svg.test.ts` | 3 files |
| `composition/graph-viz.test.ts` | 6 files |
| `composition/identifiability.test.ts` | 21 files |
| `composition/link-candidates.test.ts` | 21 files |
| `composition/linkage-map.test.ts` | 21 files |
| `composition/namespacing.test.ts` | 22 files |
| `composition/orphan-connectors.test.ts` | 21 files |
| `composition/proposed-bridges.test.ts` | 19 files |
| `composition/quantities.test.ts` | 21 files |
| `composition/retrodiction.test.ts` | 21 files |
| `composition/stress-tests.test.ts` | 20 files |
| `composition/symbolic-composition.test.ts` | 34 files |
...
| `dimensional/bridge-derivation-audit.test.ts` | 21 files |
