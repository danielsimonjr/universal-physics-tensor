...
| `canonical/canonical-equation.ts` | `public-surface.test.ts`, `bridge-equations-facade.test.ts`, `tensor.test.ts` |
...
| `canonical/registry.ts` | `public-surface.test.ts`, `bridge-equations-facade.test.ts`, `invariants.test.ts`, `linkage.test.ts`, `numeric-prefactor.test.ts`, `registry.test.ts`, `relativity.test.ts`, `seed-l-layer.test.ts`, `tensor.test.ts` |
...
| `composition/discovery.ts` | `discovery-canonical-kind.test.ts`, `discovery-magnitude.test.ts`, `discovery.test.ts` |
...
|-----------|---------------------|
| `api/public-surface.test.ts` | 81 files |
...
| `bridges/bridge-equations-facade.test.ts` | 85 files |
