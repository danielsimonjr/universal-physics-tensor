...
| `composition/bridge-analysis.ts` | `bridge-priority.test.ts`, `link-candidates.test.ts`, `linkage-map.test.ts` |
| `composition/compose-surface.ts` | `public-surface.test.ts`, `tensor.test.ts` |
| `composition/compose.ts` | `public-surface.test.ts`, `bridge-priority.test.ts`, `calibration-targets.test.ts`, `catalog-full.test.ts`, `catalog-tranche.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `enumerate-uncertainty.test.ts`, `explain.test.ts`, `identifiability.test.ts`, `link-candidates.test.ts`, `linkage-map.test.ts`, `namespacing.test.ts`, `quantities.test.ts`, `retrodiction.test.ts`, `stress-tests.test.ts`, `bridge-derivation-audit.test.ts`, `tensor.test.ts` |
...
| `dimensional/buckingham.ts` | `public-surface.test.ts`, `bridge-derivation-audit.test.ts`, `buckingham.test.ts`, `derivation-benchmark.test.ts`, `tensor.test.ts` |
...
|-----------|---------------------|
| `api/public-surface.test.ts` | 70 files |
...
| `composition/bridge-priority.test.ts` | 14 files |
| `composition/calibration-targets.test.ts` | 16 files |
| `composition/catalog-full.test.ts` | 18 files |
| `composition/catalog-tranche.test.ts` | 17 files |
| `composition/compose-properties.test.ts` | 14 files |
| `composition/compose.test.ts` | 14 files |
| `composition/enumerate-uncertainty.test.ts` | 16 files |
| `composition/explain.test.ts` | 14 files |
| `composition/identifiability.test.ts` | 14 files |
| `composition/link-candidates.test.ts` | 14 files |
| `composition/linkage-map.test.ts` | 14 files |
| `composition/namespacing.test.ts` | 15 files |
| `composition/quantities.test.ts` | 14 files |
| `composition/retrodiction.test.ts` | 14 files |
| `composition/stress-tests.test.ts` | 13 files |
...
| `dimensional/bridge-derivation-audit.test.ts` | 15 files |
