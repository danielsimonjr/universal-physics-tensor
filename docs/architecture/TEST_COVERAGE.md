...
| `composition/compose.ts` | `public-surface.test.ts`, `calibration-targets.test.ts`, `catalog-full.test.ts`, `catalog-tranche.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `enumerate-uncertainty.test.ts`, `identifiability.test.ts`, `namespacing.test.ts`, `quantities.test.ts`, `retrodiction.test.ts`, `stress-tests.test.ts`, `tensor.test.ts` |
...
|-----------|---------------------|
| `api/public-surface.test.ts` | 69 files |
...
| `composition/calibration-targets.test.ts` | 15 files |
| `composition/catalog-full.test.ts` | 17 files |
| `composition/catalog-tranche.test.ts` | 16 files |
| `composition/compose-properties.test.ts` | 13 files |
| `composition/compose.test.ts` | 13 files |
| `composition/enumerate-uncertainty.test.ts` | 15 files |
| `composition/identifiability.test.ts` | 13 files |
| `composition/namespacing.test.ts` | 14 files |
| `composition/quantities.test.ts` | 13 files |
| `composition/retrodiction.test.ts` | 13 files |
| `composition/stress-tests.test.ts` | 12 files |
