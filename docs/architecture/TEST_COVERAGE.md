...
|-----------|---------------------|
| `api/public-surface.test.ts` | 119 files |
...
| `bridges/be-18-fix.test.ts` | 11 files |
...
| `bridges/be-29-fix.test.ts` | 11 files |
...
| `bridges/be-47-fix.test.ts` | 11 files |
| `bridges/be-48-encoding.test.ts` | 4 files |
| `bridges/be-48-fix.test.ts` | 11 files |
...
| `bridges/be-55-quantum-hall.test.ts` | 14 files |
| `bridges/be-56-casimir.test.ts` | 15 files |
| `bridges/be-57-unruh.test.ts` | 13 files |
| `bridges/be-58-johnson-nyquist.test.ts` | 15 files |
| `bridges/be-59-ac-josephson.test.ts` | 14 files |
| `bridges/be-60-fractional-qh.test.ts` | 14 files |
| `bridges/be-61-wiedemann-franz.test.ts` | 14 files |
| `bridges/be-62-bcs-gap.test.ts` | 15 files |
...
| `bridges/bridge-equations-facade.test.ts` | 123 files |
| `bridges/catalog-adapter.test.ts` | 14 files |
| `bridges/catalog-grammar-applicability.test.ts` | 7 files |
| `bridges/catalog-integrity.test.ts` | 11 files |
| `bridges/catalog-json.test.ts` | 13 files |
| `bridges/confrontation-coverage.test.ts` | 1 files |
| `bridges/confrontation-registry.test.ts` | 13 files |
| `bridges/descriptor-consistency.test.ts` | 14 files |
...
| `bridges/membership.test.ts` | 13 files |
| `bridges/observation-types.test.ts` | 1 files |
| `bridges/orphan-dimensional-signature.test.ts` | 11 files |
| `bridges/perihelion-precession-labeled.test.ts` | 6 files |
| `bridges/perihelion-precession.test.ts` | 4 files |
| `bridges/public-api-stability.test.ts` | 120 files |
| `bridges/sensitivity.test.ts` | 1 files |
| `bridges/spec-vs-index.test.ts` | 11 files |
| `tests/bridges-index.test.ts` | 11 files |
...
| `canonical/invariants.test.ts` | 16 files |
...
| `composition/catalog-full.test.ts` | 38 files |
| `composition/catalog-tranche.test.ts` | 37 files |
...
| `tests/tensor.test.ts` | 119 files |
