...
- `src/numerical/formula-dimension.ts` → Expected test: `tests/unit/numerical/formula-dimension.test.ts`
...
| `composition/bridge-analysis.ts` | `bridge-priority.test.ts` |
| `composition/compose-surface.ts` | `public-surface.test.ts`, `tensor.test.ts` |
| `composition/compose.ts` | `public-surface.test.ts`, `bridge-priority.test.ts`, `calibration-targets.test.ts`, `catalog-full.test.ts`, `catalog-tranche.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `enumerate-uncertainty.test.ts`, `explain.test.ts`, `identifiability.test.ts`, `namespacing.test.ts`, `quantities.test.ts`, `retrodiction.test.ts`, `stress-tests.test.ts`, `bridge-derivation-audit.test.ts`, `tensor.test.ts` |
...
| `numerical/formula-dimension.test.ts` | 1 files |
