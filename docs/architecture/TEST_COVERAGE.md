...
| `composition/bridge-analysis.ts` | `bridge-priority.test.ts`, `discovery.test.ts`, `link-candidates.test.ts`, `linkage-map.test.ts`, `bridge-derivation-audit.test.ts` |
| `composition/bridge-prediction.ts` | `bridge-prediction.test.ts` |
| `composition/catalog-graph.ts` | `public-surface.test.ts`, `bridge-prediction.test.ts`, `bridge-priority.test.ts`, `calibration-targets.test.ts`, `catalog-full.test.ts`, `catalog-tranche.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `discovery.test.ts`, `enumerate-uncertainty.test.ts`, `explain.test.ts`, `identifiability.test.ts`, `link-candidates.test.ts`, `linkage-map.test.ts`, `namespacing.test.ts`, `quantities.test.ts`, `retrodiction.test.ts`, `stress-tests.test.ts`, `bridge-derivation-audit.test.ts`, `tensor.test.ts` |
...
| `composition/bridge-prediction.test.ts` | 17 files |
...
| `composition/discovery.test.ts` | 17 files |
