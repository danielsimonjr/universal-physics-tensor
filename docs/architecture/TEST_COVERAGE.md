...
|-------------|------------|
| `bridges/be36-gw170817-confrontation.ts` | `public-surface.test.ts`, `be36-gw170817-confrontation.test.ts`, `tensor.test.ts` |
...
| `bridges/membership-surface.ts` | `public-surface.test.ts`, `tensor.test.ts` |
...
| `bridges/rejected.ts` | `public-surface.test.ts`, `membership.test.ts`, `tensor.test.ts` |
| `composition/compose.ts` | `public-surface.test.ts`, `calibration-targets.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `tensor.test.ts` |
| `composition/consistency.ts` | `public-surface.test.ts`, `calibration-targets.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `tensor.test.ts` |
| `composition/edge.ts` | `public-surface.test.ts`, `calibration-targets.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `tensor.test.ts` |
| `edges/calibration.ts` | `public-surface.test.ts`, `calibration-targets.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `tensor.test.ts` |
| `composition/index.ts` | `public-surface.test.ts`, `calibration-targets.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `tensor.test.ts` |
| `composition/quantity.ts` | `public-surface.test.ts`, `calibration-targets.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `tensor.test.ts` |
...
| `core/types.ts` | `public-surface.test.ts`, `be-12-encoding.test.ts`, `be-13-encoding.test.ts`, `be-14-ryu-takayanagi.test.ts`, `be-19-encoding.test.ts`, `be-20-encoding.test.ts`, `be-21-encoding.test.ts`, `be-25-encoding.test.ts`, `be-27-encoding.test.ts`, `be-29-encoding.test.ts`, `be-34-encoding.test.ts`, `be-36-encoding.test.ts`, `be-42-encoding.test.ts`, `be-43-encoding.test.ts`, `be-54-encoding.test.ts`, `catalog-adapter.test.ts`, `calibration-targets.test.ts`, `addCell.test.ts`, `populated-cells.test.ts`, `tensor.test.ts` |
...
| `numerical/curvature-lowering-helpers.ts` | `bianchi-residual.test.ts`, `schwarzschild-riemann.test.ts`, `kretschmann-horizon.test.ts`, `kretschmann-schwarzschild.test.ts`, `painleve-gullstrand-curvature.test.ts`, `weyl-schwarzschild.test.ts` |
...
| `numerical/grid-field.ts` | `public-surface.test.ts`, `covariant-derivative-preview.test.ts`, `duplicate-coord-warning.test.ts`, `einstein.test.ts`, `minkowski-curvature.test.ts`, `ricci.test.ts`, `be37-covariant-eikonal-real.test.ts`, `be37-shapiro-step-sweep.test.ts`, `correctness.test.ts`, `covariant-derivative-lowering.test.ts`, `engine-default.test.ts`, `evaluate.test.ts`, `lowering-covariant-dead-else.test.ts`, `lowering-strategy-cast.test.ts`, `metric-inverse-curvature-walk.test.ts`, `metric-inverse.test.ts`, `pderiv.test.ts`, `riemann-tensor-lowering.test.ts`, `tensor.test.ts` |
...
| `numerical/kretschmann.ts` | `public-surface.test.ts`, `kretschmann-horizon.test.ts`, `kretschmann-schwarzschild.test.ts`, `painleve-gullstrand-curvature.test.ts`, `tensor.test.ts` |
...
| `numerical/painleve-gullstrand-metric.ts` | `painleve-gullstrand-curvature.test.ts` |
...
| `numerical/types.ts` | `public-surface.test.ts`, `covariant-derivative-preview.test.ts`, `duplicate-coord-warning.test.ts`, `einstein.test.ts`, `minkowski-curvature.test.ts`, `ricci.test.ts`, `be37-covariant-eikonal-real.test.ts`, `be37-shapiro-step-sweep.test.ts`, `connection-lowering-helpers.test.ts`, `correctness.test.ts`, `covariant-derivative-lowering.test.ts`, `engine-default.test.ts`, `evaluate.test.ts`, `lowering-contract.test.ts`, `lowering-covariant-dead-else.test.ts`, `lowering-covariant-guard.test.ts`, `lowering-strategy-cast.test.ts`, `metric-inverse-curvature-walk.test.ts`, `metric-inverse.test.ts`, `riemann-tensor-lowering.test.ts`, `tensor-engine-types.test.ts`, `tensor.test.ts` |
...
|-----------|---------------------|
| `api/public-surface.test.ts` | 60 files |
...
| `composition/calibration-targets.test.ts` | 9 files |
| `composition/compose-properties.test.ts` | 7 files |
| `composition/compose.test.ts` | 7 files |
