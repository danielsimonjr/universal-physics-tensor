...
| `numerical/kretschmann.ts` | `public-surface.test.ts`, `bridge-equations-facade.test.ts`, `kretschmann-factored-raising.test.ts`, `kretschmann-horizon.test.ts`, `kretschmann-schwarzschild.test.ts`, `painleve-gullstrand-curvature.test.ts`, `tensor.test.ts` |
...
|-----------|---------------------|
| `api/public-surface.test.ts` | 74 files |
...
| `bridges/bridge-equations-facade.test.ts` | 78 files |
