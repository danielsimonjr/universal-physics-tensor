...
| `composition/edge.ts` | `public-surface.test.ts`, `bridge-equations-facade.test.ts`, `bridge-prediction.test.ts`, `bridge-priority.test.ts`, `calibration-targets.test.ts`, `catalog-full.test.ts`, `catalog-tranche.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `discovery.test.ts`, `enumerate-uncertainty.test.ts`, `explain.test.ts`, `graph-viz.test.ts`, `identifiability.test.ts`, `link-candidates.test.ts`, `linkage-map.test.ts`, `namespacing.test.ts`, `orphan-connectors.test.ts`, `quantities.test.ts`, `retrodiction.test.ts`, `stress-tests.test.ts`, `symbolic-composition.test.ts`, `bridge-derivation-audit.test.ts`, `symbolic-exponent.test.ts`, `tensor.test.ts` |
...
| `composition/graph-viz.ts` | `public-surface.test.ts`, `bridge-equations-facade.test.ts`, `bridge-prediction.test.ts`, `bridge-priority.test.ts`, `calibration-targets.test.ts`, `catalog-full.test.ts`, `catalog-tranche.test.ts`, `compose-properties.test.ts`, `compose.test.ts`, `discovery.test.ts`, `enumerate-uncertainty.test.ts`, `explain.test.ts`, `graph-viz-svg.test.ts`, `graph-viz.test.ts`, `identifiability.test.ts`, `link-candidates.test.ts`, `linkage-map.test.ts`, `namespacing.test.ts`, `orphan-connectors.test.ts`, `quantities.test.ts`, `retrodiction.test.ts`, `stress-tests.test.ts`, `symbolic-composition.test.ts`, `bridge-derivation-audit.test.ts`, `symbolic-exponent.test.ts`, `tensor.test.ts` |
...
| `numerical/types.ts` | `public-surface.test.ts`, `bridge-equations-facade.test.ts`, `covariant-derivative-preview.test.ts`, `duplicate-coord-warning.test.ts`, `einstein.test.ts`, `minkowski-curvature.test.ts`, `ricci.test.ts`, `be37-covariant-eikonal-real.test.ts`, `be37-shapiro-step-sweep.test.ts`, `connection-lowering-helpers.test.ts`, `correctness.test.ts`, `covariant-derivative-lowering.test.ts`, `engine-default.test.ts`, `evaluate.test.ts`, `integral-quadrature.test.ts`, `lowering-contract.test.ts`, `lowering-covariant-dead-else.test.ts`, `lowering-covariant-guard.test.ts`, `lowering-deferred-arms.test.ts`, `lowering-strategy-cast.test.ts`, `metric-inverse-curvature-walk.test.ts`, `metric-inverse.test.ts`, `pderiv.test.ts`, `riemann-tensor-lowering.test.ts`, `tensor-engine-types.test.ts`, `tensor.test.ts` |
...
|-----------|---------------------|
| `api/public-surface.test.ts` | 84 files |
...
| `bridges/bridge-equations-facade.test.ts` | 88 files |
...
| `composition/bridge-prediction.test.ts` | 22 files |
| `composition/bridge-priority.test.ts` | 20 files |
| `composition/calibration-targets.test.ts` | 22 files |
| `composition/canonical-graph.test.ts` | 7 files |
| `composition/catalog-full.test.ts` | 24 files |
| `composition/catalog-tranche.test.ts` | 23 files |
| `composition/compose-properties.test.ts` | 20 files |
| `composition/compose.test.ts` | 20 files |
| `composition/discovery-canonical-kind.test.ts` | 4 files |
| `composition/discovery-magnitude.test.ts` | 3 files |
| `composition/discovery.test.ts` | 22 files |
| `composition/enumerate-uncertainty.test.ts` | 22 files |
| `composition/explain.test.ts` | 20 files |
| `composition/graph-viz-svg.test.ts` | 3 files |
| `composition/graph-viz.test.ts` | 6 files |
| `composition/identifiability.test.ts` | 20 files |
| `composition/link-candidates.test.ts` | 20 files |
| `composition/linkage-map.test.ts` | 20 files |
| `composition/namespacing.test.ts` | 21 files |
| `composition/orphan-connectors.test.ts` | 20 files |
| `composition/proposed-bridges.test.ts` | 19 files |
| `composition/quantities.test.ts` | 20 files |
| `composition/retrodiction.test.ts` | 20 files |
| `composition/stress-tests.test.ts` | 19 files |
...
| `dimensional/bridge-derivation-audit.test.ts` | 20 files |
...
| `dimensional/symbolic-exponent.test.ts` | 32 files |
