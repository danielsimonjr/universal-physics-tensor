...
**Exports:**
- Classes: `LabeledTensorConstructionError`, `AxisMismatchError`, `IdentityConflictError`, `RankPreservationError`, `AxisOrderError`, `LabeledTensor`
...
| `./core/labeled-tensor.js` | `LabeledTensor, LabeledTensorConstructionError, AxisMismatchError, IdentityConflictError, RankPreservationError, AxisOrderError` | Re-export |
...
| Total Modules | 7 |
| Total Lines of Code | 36902 |
| Total Exports | 1169 |
| Total Re-exports | 453 |
| Total Classes | 41 |
