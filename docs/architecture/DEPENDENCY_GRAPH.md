...
**Version**: 0.32.0 | **Last Updated**: 2026-07-03
...
| `../canonical-equation.js` | `CanonicalEquation` | Import (type-only) |
| `../../bridges/equations/_be-helpers.js` | `sym` | Import |
| `../../dimensional/types.js` | `MASS, VELOCITY, ACCELERATION, FORCE, LENGTH, AREA, FREQUENCY` | Import |
...
| `confrontations` | 6 files | 4 files |
...
| Total Modules | 10 |
| Total Lines of Code | 46870 |
| Total Exports | 1527 |
| Total Re-exports | 680 |
| Total Classes | 49 |
| Total Interfaces | 169 |
| Total Functions | 352 |
| Total Type Guards | 3 |
| Total Enums | 0 |
| Type-only Imports | 320 |
