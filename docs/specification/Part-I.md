...
> **Spec-scope note (added 2026-05-20; updated 2026-06-10):** "BE-11 through BE-50" was the *original* formal spec catalog (40 bridges). The catalog now spans **44 bridges, IDs 11–54**: BE-51 (gravitational lensing) and BE-52 (Mercury perihelion) were added in v0.4.0, BE-53 (Yang-Mills β-function) and BE-54 (Randall-Sundrum brane cosmology) in v0.7 — all four are catalogued in Part-II §V-B and shipped in `src/bridges/index.ts`; see the Part-II §V preamble spec-scope note.
