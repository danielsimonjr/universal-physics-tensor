...
- **Status**: **INVALID** (R3 disposition 2026-05-05, Wave J Tier B1, per Phys iter-1 C2 + Math M-I5 iter-2 paper review). The third term `B √(ℏ/(k_B T τ_P))` collapses to `B · 1` identically because `τ_P · k_B T = ℏ` is a definitional identity, so any monomial built from those two scales alone is fixed. The displayed formula therefore has the same content as `ρ(T) = ρ_0 + B + AT` — a constant-shifted Drude (linear-in-T) form, NOT Planckian dissipation. Earlier history: [2026-05-01] downgraded from 'established' to 'speculative' (R0 audit); [2026-05-05, this commit] R2→R3: a non-vacuous third term must introduce a *second* timescale or energy scale (e.g., τ_el, SYK J, E_F, MSS Lyapunov bound λ_L = 2π k_B T/ℏ), which is a research-program commitment, not a transcription fix. Preserved verbatim below as historical record. **Do not cite as a quantitative prediction.**
...
- **Status**: Established form (after correction). Standard composite Higgs potentials (Kaplan-Georgi 1984 *Phys. Lett. B* 136:183; Contino-Grojean-Moretti-Piccinini-Rattazzi 2007 *JHEP* 0706:045, arXiv:hep-ph/0703164) have the structure V(h) ∼ α f⁴ sin²(h/f) + β f⁴ sin⁴(h/f) with α and β dimensionless Wilson coefficients and all terms of dimension [E]⁴. **Corrected on 2026-05-05 (Wave J Tier C5, per Phys C-NEW iter-2 + Phys I7 iter-2 paper review):** the previous draft had `-α f²` in the first term, making it carry [E]² while β f⁴[...] carries [E]⁴ — dimensionally inhomogeneous. Replaced f² with f⁴.
...
> **Corrected on 2026-05-05 (Wave J Tier C5):** The previous form `-α f² sin²(h/f) + β f⁴[...]` was dimensionally inhomogeneous (first term [E]², second term [E]⁴). The standard Kaplan-Georgi / Contino-Grojean-Moretti-Piccinini-Rattazzi form is `-α f⁴ sin²(h/f) + β f⁴ sin⁴(h/f)` with both α, β dimensionless. The f² → f⁴ correction is the minimal fix flagged by Physicist iter-1 (I7) and Physicist C-NEW iter-2 paper reviews. Citation: Contino-Grojean-Moretti-Piccinini-Rattazzi 2007 *JHEP* 0706:045 (arXiv:hep-ph/0703164), §3.
