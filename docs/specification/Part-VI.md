...
The specification's size and statistics are recorded in the authoritative "Framework Statistics (honest)" block below in this Part-VI §29 (single source of truth, designated 2026-05-06 Wave N-completion Tier E7). The serious next steps for making this a viable research artifact are:
