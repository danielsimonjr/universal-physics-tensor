...
| 1 — Relation contracts overlay | overlay shipped; "zero fabricated assumptions" NOT MET by the sample | Sample: 5 of 6 citations overclaimed. Census of all 15: 0 overclaims remain; 13 checked, BE-11 on search snippets only, C6 (Josephson 1962, paywalled) disclosed as unverifiable. Ruling (Mothership, 2026-09-24): may be recorded MET only if all 15 are checked with 0 remaining overclaims, C6 disclosed and not counted as checked. Open: the ruling on BE-11. [`docs/research/phase-1-citation-check.md`](docs/research/phase-1-citation-check.md) |
